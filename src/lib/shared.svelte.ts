...
export const presets = [
    ...
    {
        name: "Medium Iced White Chocolate Mocha",
        preset: [
            {
                id: "00",
                category: "flavor",
